...
CREATE OR REPLACE FUNCTION sub(a numeric, b numeric) RETURNS numeric AS $$
  SELECT a - b;
$$ LANGUAGE SQL IMMUTABLE PARALLEL SAFE
RETURNS NULL ON NULL INPUT;

CREATE OR REPLACE FUNCTION mult(a numeric, b numeric) RETURNS numeric AS $$
  SELECT a * b;
$$ LANGUAGE SQL IMMUTABLE PARALLEL SAFE
RETURNS NULL ON NULL INPUT;

CREATE OR REPLACE FUNCTION div(a numeric, b numeric) RETURNS numeric AS $$
  SELECT a / b;
$$ LANGUAGE SQL IMMUTABLE PARALLEL SAFE
RETURNS NULL ON NULL INPUT;

CREATE OR REPLACE FUNCTION mod(a numeric, b numeric) RETURNS numeric AS $$
  SELECT a % b;
$$ LANGUAGE SQL IMMUTABLE PARALLEL SAFE
RETURNS NULL ON NULL INPUT;
