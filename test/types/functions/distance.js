  ...
  it('should work', async () => {
    const funcVal = {
      ...
      arguments: [
        ...
        {
          function: 'geojson',
          arguments: ['{"type":"Point","coordinates":[1.01,8]}']
        }
      ]
    }
    const fullQuery = {
      ...
      aggregations: [
        {
          value: { function: 'average', arguments: [funcVal] },
          alias: 'totalDistance'
        },
  ...
  it('should work when intersecting', async () => {
    const funcVal = {
      ...
      arguments: [
        ...
        {
          function: 'geojson',
          arguments: ['{"type":"Point","coordinates":[1,9]}']
        }
      ]
    }
    const fullQuery = {
      ...
      should(err.fields).eql([
        {
          ...
          value: 'abc',
          message:
            'Argument "Geometry B" for "Distance" must be of type: point, polygon, multipolygon, line, multiline, geometry - instead got text'
        }
      ])
      return
    }
  ...
  it('should bubble up schema correctly', async () => {
    const funcVal = {
      ...
      arguments: [
        ...
        {
          function: 'geojson',
          arguments: ['{"type":"Point","coordinates":[100, 100]}']
        }
      ]
    }
    const fullQuery = {
      ...
      aggregations: [
        {
          value: { function: 'sum', arguments: [funcVal] },
          alias: 'totalDistance'
        },
        { value: { field: 'data.type' }, alias: 'type' }
      ],
